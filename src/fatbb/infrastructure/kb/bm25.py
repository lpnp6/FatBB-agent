...
class PostgresBm25KnowledgeBase:
    ...
    def check_connection(self, database_url: str) -> None:
        ...
        PostgresBM25SearchStore(database_url).check_connection()

    def indexer(self, database_url: str) -> BM25Indexer:
        return BM25Indexer(MarkdownChunker(), PostgresBM25SearchStore(database_url))

    def retriever(self, database_url: str) -> BM25Retriever:
        return BM25Retriever(PostgresBM25SearchStore(database_url))
